...
<div {{ $attributes->class(['group rounded-lg border border-cream-200 bg-white p-8 transition duration-300 hover:-translate-y-1 hover:border-navy-200 hover:shadow-[0_18px_40px_-24px_rgb(18_41_74_/_0.28)] dark:border-night-700 dark:bg-night-800 dark:hover:border-night-500 dark:hover:shadow-[0_18px_40px_-24px_rgb(0_0_0_/_0.6)] motion-reduce:transition-none motion-reduce:hover:translate-y-0']) }}>
    <span class="mb-6 flex h-13 w-13 items-center justify-center rounded-lg bg-cream-100 text-navy-700 transition duration-300 group-hover:bg-navy-800 group-hover:text-cream-100 dark:bg-night-700 dark:text-cream-200 dark:group-hover:bg-cream-100 dark:group-hover:text-navy-800 motion-reduce:transition-none">
        @switch($icon)
            @case('hands')
                <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M6.633 10.25c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 0 1 2.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 0 0 .322-1.672V3a.75.75 0 0 1 .75-.75 2.25 2.25 0 0 1 2.25 2.25c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282m0 0h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 0 1-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 0 0-1.423-.23H5.904m10.598-9.75H14.25M5.904 18.5c.083.205.173.405.27.602.197.4-.078.898-.523.898h-.908c-.889 0-1.713-.518-1.972-1.368a12 12 0 0 1-.521-3.507c0-1.553.295-3.036.831-4.398C3.387 9.953 4.167 9.5 5 9.5h1.053c.472 0 .745.556.5.96a8.958 8.958 0 0 0-1.302 4.665c0 1.194.232 2.333.654 3.375Z"/></svg>
                @break
            @case('sun')
    ...
    <h3 class="font-display text-lg font-semibold text-navy-900 dark:text-cream-100">{{ $title }}</h3>
    <p class="mt-2 text-sm leading-relaxed text-stone-600 dark:text-navy-300">{{ $slot }}</p>
</div>
